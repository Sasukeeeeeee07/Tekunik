    ...
    <div className="min-h-screen bg-gradient-to-br from-[#00A650]/10 via-[#2B3990]/5 to-[#00A650]/10 py-20">
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="relative">
          {/* Decorative Elements */}
          <div className="absolute -top-10 -right-10 w-40 h-40 bg-[#00A650] rounded-full blur-[100px] opacity-20 animate-pulse"></div>
          <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-[#2B3990] rounded-full blur-[100px] opacity-20 animate-pulse"></div>
          ...
          <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-white/20">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl font-bold text-gray-800 mb-4">Mobile App Questionnaire</h1>
              <p className="text-gray-600">Help us understand your mobile app requirements better</p>
            </div>
