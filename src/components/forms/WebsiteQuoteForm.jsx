...
const WebsiteQuoteForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#00A650]/10 via-[#2B3990]/5 to-[#00A650]/10 py-20">
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="relative">
          {/* Decorative Elements */}
          <div className="absolute -top-10 -right-10 w-40 h-40 bg-[#00A650] rounded-full blur-[100px] opacity-20"></div>
          <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-[#2B3990] rounded-full blur-[100px] opacity-20"></div>
          
          <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-white/20">
            {/* Form Header with Gradient */}
            <div className="text-center mb-12">
              <div className="w-24 h-2 bg-gradient-to-r from-[#00A650] to-[#2B3990] mx-auto mb-4 rounded-full"></div>
              <h1 className="text-4xl font-bold text-gray-800 mb-4">Website Questionnaire</h1>
              <p className="text-gray-600">Help us understand your website needs better</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="text-center pt-10">
                <div className="w-32 h-1 bg-gradient-to-r from-[#00A650] to-[#2B3990] mx-auto mb-8 rounded-full"></div>
                <p className="text-xl font-semibold text-gray-800 mb-4">That's all we need for now!</p>
                <p className="text-gray-600 mb-8">Thanks for taking time to fill this in - we'll be in touch with a quotation shortly.</p>
                <button
                  type="submit"
                  className="relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-medium transition-all bg-gradient-to-r from-[#00A650] to-[#2B3990] rounded-lg hover:from-[#2B3990] hover:to-[#00A650] text-white shadow-lg group"
                >
