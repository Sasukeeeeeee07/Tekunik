          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="px-8 py-4 bg-[#00A650] text-white rounded-full text-lg font-semibold hover:bg-[#008c43] transition-all duration-300 transform hover:scale-105"
              >
                GET STARTED
              </button>
            ...
            <div className="mt-20 grid grid-cols-2 md:grid-cols-3 gap-8">
              {stats.map((stat, index) => (
                <div key={index} className="backdrop-blur-lg bg-white/10 p-6 rounded-xl">
                  <div className="text-3xl font-bold text-[#00A650] mb-2">
